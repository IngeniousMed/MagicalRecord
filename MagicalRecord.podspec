#
# Be sure to run `pod spec lint MagicalRecord.podspec' to ensure this is a
# valid spec.
#
...
Pod::Spec.new do |s|
  ...
  s.version      = "0.0.1"
  s.summary      = "A short description of MagicalRecord."
  # s.description  = <<-DESC
  #                   An optional longer description of MagicalRecord
  #
  #                   * Markdonw format.
  #                   * Don't worry about the indent, we strip it!
  #                  DESC
  s.homepage     = "http://EXAMPLE/MagicalRecord"
  ...
  #
  s.author       = { "Ross Chapman" => "ross.chapman@me.com" }
  # s.authors      = { "Ross Chapman" => "ross.chapman@me.com", "other author" => "and email address" }
  #
  # If absolutely no email addresses are available, then you can use this form instead.
  #
  # s.author       = 'Ross Chapman', 'other author'
